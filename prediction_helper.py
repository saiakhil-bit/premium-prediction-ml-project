...
model_dr = "artifacts/model_young.joblib"
model_dy = "artifacts/model_young.joblib"
scaler_dr= "artifacts/scaler_rest.joblib"
scaler_dy="artifacts/scaler_young.joblib"
model_rest = load(model_dr)
model_young=load(model_dy)
scaler_rest=load(scaler_dr)
scaler_young=load(scaler_dy)
